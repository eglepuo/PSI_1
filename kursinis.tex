...
Šiame dokumente kuriamos sistemos architektūra aprašoma naudojant UML 4+1 požiūrių
...
\begin{enumerate}
	...
	\item Pasirinktas dėstytojas - dėstytojo puslapio informacija keliauja iš duomenų bazės iki studento.
	\item Pasirinktas dėstytojas - dėstytojo puslapio informacija keliauja iš duomenų bazės iki studento.
	\item Pasirinktas dėstytojas - dėstytojo puslapio informacija keliauja iš duomenų bazės iki studento.
\end{enumerate}
...
\begin{figure}[H]
	...
	\label{fig:compTwo}
\end{figure}
Mazgų ir artefaktų diagramoje (\ref{fig:compTwo} pav.) parodo, kad tinklalapis yra serveryje, kuris bendrauja http protokolu su SQL serveriu, kuriame saugoma duomenų bazė. Naudotojai turi galimybe pasiekti sistemos teikiamas paslaugas savo pasirinkta naršykle, kuri palaiko http protokolą.
